...
namespace Typespot.Controllers
{
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> Edit ()
        {
            ...
            var model = UserManager.FindById(currentId);
            if( model == null )
            {
        ...
        [HttpPost]
        public async Task<ActionResult> Edit ( [Bind( Include = "Id,PersonalityId,Email,FullName,PhoneNumber,UserName,ImageUrl,File" )] ApplicationUser model )
        {
            if( ModelState.IsValid )
            {
                model.UploadFile();
